...
public class CrestedDuckModel extends HierarchicalModel<DuckEntity> {
    ...
    public CrestedDuckModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = neck.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 28).addBox(-0.899F, -2.9548F, 0.0383F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(20, 0).addBox(-1.5F, -2.2116F, -1.4997F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition beak = head.addOrReplaceChild("beak", CubeListBuilder.create().texOffs(28, 14).addBox(-1.0F, 0.25F, -1.0F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.0611F, -0.1648F, -2.0931F));

        PartDefinition top_bill = beak.addOrReplaceChild("top_bill", CubeListBuilder.create().texOffs(28, 11).addBox(-0.9604F, -1.7712F, -0.7573F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.05F)), PartPose.offset(0.0215F, 1.0212F, -0.2427F));
        ...
        PartDefinition wing_left = body.addOrReplaceChild("wing_left", CubeListBuilder.create().texOffs(0, 11).addBox(-0.5608F, -1.1344F, -1.6699F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(30, 6).addBox(-0.8446F, -1.1711F, 5.3292F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.6047F, -0.2954F, -1.7664F, 0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition wing_right = body.addOrReplaceChild("wing_right", CubeListBuilder.create().texOffs(14, 11).addBox(-0.3108F, -1.1344F, -1.6699F, 1.0F, 4.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(8, 30).addBox(-0.0946F, -1.1711F, 5.3292F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.6453F, -0.2954F, -1.7664F, 0.0436F, 0.0F, 0.0F));
        ...
        PartDefinition leg_right = root.addOrReplaceChild("leg_right", CubeListBuilder.create().texOffs(8, 27).addBox(-1.5F, 3.0F, -3.0F, 3.0F, 0.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(12, 30).addBox(-0.5F, 0.999F, 0.0F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(1.5F, -3.0F, 2.0F));
