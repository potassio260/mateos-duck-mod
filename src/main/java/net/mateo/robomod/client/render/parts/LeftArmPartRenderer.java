...
public class LeftArmPartRenderer extends CyborgPartRenderer {

    public LeftArmPartRenderer(String name, String texture, Supplier<CyborgPartsModel> model) {
    ...
    public void render(PlayerModel<?> contextModel, PoseStack poseStack,
        ...
        this.model.get().getLeftArm().copyFrom(contextModel.leftArm);
        ...
        this.model.get().getLeftArm().render(poseStack, vertexConsumer, packedLight, OverlayTexture.NO_OVERLAY);
    }
    ...
    public void renderAssembler(AssemblerBlockEntity assembler, BlockState state, float tickDelta,
        ...
        poseStack.pushPose();
        this.model.get().getLeftArm().resetPose();
        this.model.get().getLeftArm().x = 5;
        this.model.get().getLeftArm().y = -22;
