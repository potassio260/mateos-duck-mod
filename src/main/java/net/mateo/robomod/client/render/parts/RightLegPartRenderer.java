...
public class RightLegPartRenderer extends CyborgPartRenderer {

    public RightLegPartRenderer(String name, String texture, Supplier<CyborgPartsModel> model) {
    ...
    public void render(PlayerModel<?> contextModel, PoseStack poseStack,
        ...
        this.model.get().getRightLeg().copyFrom(contextModel.rightLeg);
        ...
        this.model.get().getRightLeg().render(poseStack, vertexConsumer, packedLight, OverlayTexture.NO_OVERLAY);
    }
    ...
    public void renderAssembler(AssemblerBlockEntity assembler, BlockState state, float tickDelta,
        ...
        poseStack.pushPose();
        this.model.get().getRightLeg().resetPose();
        this.model.get().getRightLeg().x = -1.9F;
        this.model.get().getRightLeg().y = -12;
