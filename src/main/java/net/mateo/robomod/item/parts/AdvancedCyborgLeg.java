...
import net.mateo.robomod.item.CyborgLegPartItem;
...
public class AdvancedCyborgLeg extends CyborgLegPartItem {
    ...
    public AdvancedCyborgLeg(String right, String left, int energyCapacity, double health, Item.Properties properties) {
